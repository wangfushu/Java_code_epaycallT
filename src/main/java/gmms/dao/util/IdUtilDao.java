...
/*    public DataSource getDataSource() {
   ...
   private static  String url = "jdbc:sqlserver://172.16.54.188:1433;databaseName=VYearFee";
   // private static  String url = "jdbc:sqlserver://localhost:1433;databaseName=VYearFee4S";
