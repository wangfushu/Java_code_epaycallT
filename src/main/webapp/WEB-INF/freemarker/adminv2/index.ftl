...
<head>
	...
	<!--请在下方写此页面业务相关的脚本-->
	<script type="text/javascript" src="${absoluteContextPath}/H-ui-admin/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
				...
				<ul class="cl">
					<li class="dropDown dropDown_hover"><a href="javascript:;" class="dropDown_A"><i class="Hui-iconfont">&#xe600;</i> 新增 <i class="Hui-iconfont">&#xe6d5;</i></a>
						<ul class="dropDown-menu menu radius box-shadow">
							<li><a href="javascript:;" onclick="article_add('添加房产','${absoluteContextPath}/admin/renthouse/releaseHouse')"><i class="Hui-iconfont">&#xe616;</i> 房产</a></li>
							<li><a href="javascript:;" onclick="member_add('添加用户','${absoluteContextPath}/admin/users/edit','','510')"><i class="Hui-iconfont">&#xe60d;</i> 用户</a></li>
						</ul>
					</li>
				</ul>
			</nav>
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			...
			<dd>
				<ul>
					<li><a data-href="${absoluteContextPath}/admin/renthouse" data-title="房产管理" href="javascript:void(0)">房产管理</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-member">
			...
			<dd>
				<ul>
					<li><a data-href="${absoluteContextPath}/admin/users" data-title="用户管理" href="javascript:;">用户管理</a></li>
				</ul>
			</dd>
		</dl>
	</div>
...
<section class="Hui-article-box">
	<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active">
					<span title="我的桌面" data-href="${absoluteContextPath}/admin/renthouse">我的桌面</span>
					<em></em></li>
			</ul>
		</div>
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" frameborder="0" src="${absoluteContextPath}/admin/renthouse"></iframe>
		</div>
	</div>
</section>
